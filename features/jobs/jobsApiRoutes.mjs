...
import { parseJobId } from './services/jobId.mjs'
...
// Job addressing (<ownerApp>.jobs.<jobName>) is parsed by parseJobId — now in
// services/jobId.mjs so capability reporting (/ceps/ping) can share it.
