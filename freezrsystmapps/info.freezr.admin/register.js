// admin/register register.js
/* global freezerRestricted, freezr */

freezr.initPageScripts = function () {
  console.log('initPageScripts register.js loaded 1')
  document.getElementById('register').onsubmit = function (evt) {
    ...
    if (!userId || !password) {
      ...
      ;(async () => {
        try {
          const data = await freezr.apiRequest('POST', '/register/api/newUserViaAdmin', theInfo)
