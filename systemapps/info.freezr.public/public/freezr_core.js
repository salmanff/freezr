...
// freezr.perms.getValidationToken = function (options, callback) {
//   if (!options.data_owner_user || !options.table_id || !options.permission) {
//     callback(new Error('must incude data_owner_user, table_id, permission'))
//   } else {
//     const params = {
//       data_owner_user: options.data_owner_user,
//       table_id: options.table_id,
//       permission: options.permission,
//       requestor_user: freezrMeta.userId,
